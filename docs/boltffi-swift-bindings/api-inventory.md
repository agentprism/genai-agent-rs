...
#### Models middleware and API-family type-parameter graph
...
| `pi_ai::ApiFamily` | `crates/pi-ai/src/options.rs:368` | non-generic trait with five associated types and three sync functions | Send | extended | API-family contract used by generic `Models::stream_api<A>`, typed payload transforms, model narrowing, lowering, and encoding. |
