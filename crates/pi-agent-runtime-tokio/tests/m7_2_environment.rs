...
use pi_agent_runtime_tokio::{TokioAgentEnvironment, TokioAgentFileSystem};
use pi_ai::CancellationToken;
use std::{
    io::{Read, Write},
    time::Duration,
};
...
async fn collect_process(
    process: &mut dyn pi_agent_env::RunningProcess,
) -> (Vec<u8>, Vec<u8>, pi_agent_env::ProcessOutcome) {
