...
fn resume_compaction_spec(
    ...
    state: &agentprism_session::SessionState,
    run_id: &agentprism_ai::RunId,
...
fn latest_compaction_details(path: &[SessionEntry]) -> Option<agentprism_ai::VersionedExtension> {
...
fn append_entry_records(
    ...
    match entry {
        SessionEntry::Message {
            ...
            && assistant.finish.reason == agentprism_ai::AssistantFinishReason::Deferred => {}
...
fn apply_session_overrides(
    ...
    reconstructed_options: &agentprism_ai::SimpleGenerationOptions,
...
fn options_with_reasoning(
    configured: &agentprism_ai::SimpleGenerationOptions,
    reasoning: ReasoningLevel,
) -> agentprism_ai::SimpleGenerationOptions {
