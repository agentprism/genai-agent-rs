...
use agentprism_core::{AgentRecord, AgentStateView, ContextPolicy, PreparedAgentRecords};
...
impl OverflowRetryExecutor {
    ...
    async fn execute_attempt(
        &self,
        state: &agentprism_core::AgentState,
        records: &[AgentRecord],
        tools: &[agentprism_ai::ToolSpec],
        model: &agentprism_ai::ModelRef,
        reasoning: agentprism_ai::ReasoningLevel,
        options: &agentprism_ai::SimpleGenerationOptions,
        run_id: RunId,
        step: &dyn AssistantStep,
        cancellation: CancellationToken,
