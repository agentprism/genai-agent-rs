...
use crate::{
    ...
    DefaultContextPolicy, DefaultMessageProjector, DefaultTurnPolicy, LocalAgentDefaults,
    LocalContextPolicy, LocalMessageProjector, LocalToolRegistry, LocalToolScheduler,
    LocalTurnPolicy, MessageProjector, QueueReceiver, ToolExecutionMode, ToolRegistry,
    ToolScheduler,
};
use agentprism_ai::{
...
pub struct Agent {
    ...
    pub(crate) active_run: Option<agentprism_ai::RunId>,
    ...
    pub(crate) message_projector: Arc<dyn MessageProjector>,
...
pub struct LocalAgent {
    ...
    pub(crate) message_projector: Rc<dyn LocalMessageProjector>,
