...
use agentprism_core::{Agent, AgentEvent, AgentState, PromptImage, PromptText, ToolRegistry};
use agentprism_runtime_tokio::{AgentEventSink, TokioAgentError, TokioAgentHandle, TokioAgentRun};
use auth_session::{
...
enum BindingRunState {
    ...
    Active { core_run_id: agentprism_ai::RunId },
}
...
struct BindingEventSink {
    ...
    core_run_id: Mutex<Option<agentprism_ai::RunId>>,
...
impl AuthResolver for ScriptedAuthResolver {
    fn resolve(
        &self,
        _request: agentprism_ai::ResolveAuthRequest,
        cancellation: CancellationToken,
...
mod tests {
    ...
    use agentprism_core::{AgentEvent, AgentRecord, ToolOutput};
