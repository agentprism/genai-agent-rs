//! Google provider authentication and Vertex credential resolution.
...
use pi_ai::{
    ...
    CancellationToken, Credential, EnvironmentApiKeyAuth, HttpRequest, HttpTransport,
    LocalApiKeyAuth, LocalApiKeyResolveRequest, LocalAuthInteraction, LocalAuthResolver,
    LocalBoxFuture, LocalHttpTransport, LocalProviderAuthResolver, LocalResolveAuthRequest,
...
fn custom_model_base_url(
    model: Option<&pi_ai::ModelDescriptor>,
    catalog_default: &str,
) -> Option<Url> {
