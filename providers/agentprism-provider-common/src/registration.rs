...
pub fn build_provider(
    id: &str,
    display_name: &str,
    models: Vec<agentprism_ai::ModelDescriptor>,
    auth: Arc<dyn AuthResolver>,
    apis: impl IntoIterator<Item = (ApiId, Arc<dyn agentprism_ai::ChatApi>)>,
...
pub fn build_local_provider(
    ...
    apis: impl IntoIterator<Item = (ApiId, Rc<dyn agentprism_ai::LocalChatApi>)>,
...
macro_rules! define_static_provider {
    (
        ...
        pub fn models() -> Result<Vec<agentprism_ai::ModelDescriptor>, $crate::ProviderBuildError> {
        ...
        ) -> Result<agentprism_ai::ProviderRegistration, $crate::ProviderBuildError> {
            let apis: Vec<(agentprism_ai::ApiId, std::sync::Arc<dyn agentprism_ai::ChatApi>)> = vec![
                (agentprism_ai::ApiId::new($api), $($send)::+($send_input.http.clone())),
                $((agentprism_ai::ApiId::new($more_api), $($more_send)::+($more_send_input.http.clone()))),*
            ];
        ...
        ) -> Result<agentprism_ai::LocalProviderRegistration, $crate::ProviderBuildError> {
            let apis: Vec<(agentprism_ai::ApiId, std::rc::Rc<dyn agentprism_ai::LocalChatApi>)> = vec![
                (agentprism_ai::ApiId::new($local_api), $($local)::+($local_input.http.clone())),
                $((agentprism_ai::ApiId::new($more_local_api), $($more_local)::+($more_local_input.http.clone()))),*
            ];
