...
impl RadiusOAuth {
    ...
    pub fn new(transport: Arc<dyn agentprism_ai::HttpTransport>, gateway: Url) -> Self {
...
fn device_request(gateway: &Url) -> Result<agentprism_ai::HttpRequest, AuthError> {
...
fn unsupported_redirect(capabilities: agentprism_ai::AuthHostCapabilities) -> AuthError {
    AuthError::UnsupportedRedirectStrategy {
        provider: agentprism_ai::ProviderId::new("radius"),
...
fn get_json(url: Url) -> agentprism_ai::HttpRequest {
    let mut headers = HeaderMap::new();
    headers.insert(header::ACCEPT, HeaderValue::from_static("application/json"));
    agentprism_ai::HttpRequest {
