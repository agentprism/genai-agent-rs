...
impl pi_ai_bedrock::BedrockSigner for NoNetwork {
    fn execute(
        &self,
        _config: pi_ai_bedrock::BedrockSigningConfig,
        _request: HttpRequest,
        _cancellation: CancellationToken,
    ) -> SendBoxFuture<
        '_,
        Result<pi_ai_bedrock::BedrockSignerResponse, pi_ai_bedrock::BedrockSignerError>,
    > {
        unreachable!("provider construction does not execute the signer")
    }
}

impl pi_ai_bedrock::LocalBedrockSigner for NoNetwork {
    fn execute(
        &self,
        _config: pi_ai_bedrock::BedrockSigningConfig,
        _request: HttpRequest,
        ...
        '_,
        Result<pi_ai_bedrock::LocalBedrockSignerResponse, pi_ai_bedrock::BedrockSignerError>,
    > {
        unreachable!("provider construction does not execute the signer")
    }
}
...
fn remaining_provider_auth_is_api_family_scoped_send_and_local_pi_exact() {
    ...
    let send = pi_ai_opencode::provider(pi_ai_provider_common::ProviderInputs {
        http: Arc::new(NoNetwork),
        environment: BTreeMap::new(),
    })
    .unwrap();
    ...
    let local = pi_ai_opencode::local_provider(pi_ai_provider_common::LocalProviderInputs {
        http: Rc::new(NoNetwork),
        environment: BTreeMap::new(),
    })
    .unwrap();
