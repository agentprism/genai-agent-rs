...
pub fn deepseek_models() -> Result<Vec<pi_ai::ModelDescriptor>, ProviderBuildError> {
    models()
}
...
pub fn provider_with_api(
    ...
    pi_ai_provider_common::build_provider(
        ...
        "DeepSeek",
        models()?,
        pi_ai_provider_common::bearer_auth("DeepSeek API key", "DEEPSEEK_API_KEY", None),
...
pub fn provider(inputs: ProviderInputs) -> Result<pi_ai::ProviderRegistration, ProviderBuildError> {
    provider_with_api(pi_ai_openai::openai_completions_api(inputs.http))
}
...
pub fn local_provider_with_api(
    ...
    pi_ai_provider_common::build_local_provider(
        ...
        "DeepSeek",
        models()?,
        pi_ai_provider_common::local_bearer_auth("DeepSeek API key", "DEEPSEEK_API_KEY", None),
        [(ApiId::new("openai-completions"), api)],
    )
}
...
pub fn local_provider(
    ...
    local_provider_with_api(pi_ai_openai::local_openai_completions_api(inputs.http))
}
