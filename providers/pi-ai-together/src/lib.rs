...
pi_ai_provider_common::define_static_provider! {
    id: "together", name: "Together", auth_name: "Together API key", env: "TOGETHER_API_KEY",
    catalog: pi_ai_openai::parse_openai_published_catalog(include_str!("../data/models.json"), "together", "openai-completions"),
